...
//post method used to submit confidential information. get method places keywords in url
   $backgroundImage = "img/sea.jpg";
   if (isset($_GET['keyword'])) {
        include 'api/pixabayAPI.php'; //MUST REQUEST PERSONAL API KEY
        ...
        //Line 10 and 11 perform the same thing
...
<html>
    ...
    <body>
        ...
        <form method="GET">
            <input type= "text" size = "20" name= "keyword" placeholder= "Keyword to search" value= "<?=$_GET['keyword']?>"/>
            ...
            >
            <label for="hlayout"> Horizontal </layout>
